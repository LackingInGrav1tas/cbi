...
enum Command {
    ...
    //infix operators
    OP_ADD, OP_SUB, OP_MUL, OP_DIV, OP_MODULO, OP_CONCATENATE, OP_AND, OP_OR,
    ...
    OP_BEGIN_NAMESPACE, OP_END_NAMESPACE,
    OP_USE_NAMESPACE,
