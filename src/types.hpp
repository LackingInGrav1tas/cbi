...
enum Command {
    ...
    OP_BEGIN_SCOPE, OP_END_SCOPE, OP_JUMP, OP_BREAK, OP_CALL, OP_DECL_FN, OP_EMPTY_STACK,
    OP_RETURN_TOP, OP_DISASSEMBLE_STACK, OP_DISASSEMBLE_SCOPES, OP_DISASSEMBLE_CONSTANTS, OP_GETS, OP_GETCH, OP_CONVERT,
    OP_REQUIRE_NUM, OP_REQUIRE_STR, OP_REQUIRE_BOOL, OP_REQUIRE_VOID, OP_AT, OP_DECL_LIST, OP_PUSH_LIST,
    OP_POP_LIST, OP_BACK_LIST, OP_FRONT_LIST, OP_INDEX_LIST, OP_SIZEOF, OP_DECL_LIST_INDEX, OP_CONVERT_ASCII, OP_THROW,
    OP_CONSOLE, OP_SLEEP, OP_RAND
};
